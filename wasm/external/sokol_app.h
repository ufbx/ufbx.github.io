...
/* attempt pause the event loop */
SOKOL_APP_API_DECL void sapp_request_pause(void);
/* resume the event loop (returns from sapp_request_pause()) */
SOKOL_APP_API_DECL void sapp_request_resume(void);
...
_SOKOL_PRIVATE EM_BOOL _sapp_emsc_frame(double time, void* userData) {
    ...
    if (_sapp.pause_requested) {
        _sapp.pause_requested = false;
        _sapp.paused = true;
        return EM_FALSE;
    }
    return EM_TRUE;
...
_SOKOL_PRIVATE void _sapp_emsc_resume() {
...
SOKOL_API_IMPL void sapp_request_pause(void) {
    _sapp.pause_requested = true;
}

SOKOL_API_IMPL void sapp_request_resume(void) {
    if (_sapp.pause_requested) {
        _sapp.pause_requested = false;
    }
    if (_sapp.paused) {
